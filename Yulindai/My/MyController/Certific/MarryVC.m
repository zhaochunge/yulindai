...
@interface MarryVC ()
<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    [self leftItem];
    _selectPic = 0;
    self.navigationItem.title = @"结婚认证";
    ...
    [cerTools title:@"结婚认证" font:17 discrib:discribStr withFrame:CGRectMake(20, top, WIDTH-40, height) view:self.scrollView showLine:YES];
    //所在城市
    top = height+top+20;
