...
@interface IncomeCerVC ()<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    [self leftItem];
    _selectPic = 0;
    self.navigationItem.title = @"收入认证";
    ...
    [cerTools title:@"收入认证" font:17 discrib:discribStr withFrame:CGRectMake(20, top, WIDTH-40, height) view:self.scrollView showLine:YES];
