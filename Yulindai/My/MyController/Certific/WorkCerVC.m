...
@interface WorkCerVC ()<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>
@property(nonatomic,strong)UIScrollView *scrollView;
@property(nonatomic,strong)LTView *nameView;
@property(nonatomic,strong)LTView *positionView;
@property(nonatomic,strong)LLBView *statusView;
@property(nonatomic,strong)LLBView *cityView;
@property(nonatomic,strong)LLBView *addressView;
@property(nonatomic,strong)LTView *incomeView;
@property(nonatomic,strong)LLBView *industryView;
...
- (void)viewDidLoad {
    ...
    [self leftItem];
    _selectPic = 0;
    self.navigationItem.title = @"工作认证";
    ...
    self.nameView.titleLab.text = @"单位名称";
    self.nameView.textField.delegate = self;
    [self.scrollView addSubview:self.nameView];
    //职业状态
    top = top+60;
    self.statusView = [[LLBView alloc] initWithFrame:CGRectMake(20, top, WIDTH-40, 50)];
    _statusView.titleLab.text = @"职业状态";
    [self.scrollView addSubview:self.statusView];
    //工作城市
    top = top +60;
    self.cityView = [[LLBView alloc] initWithFrame:CGRectMake(20, top, WIDTH-40, 50)];
    _cityView.titleLab.text = @"工作城市";
    [_scrollView addSubview:_cityView];
    //职位
    top = top +60;
    self.positionView = [[LTView alloc] initWithFrame:CGRectMake(20 ,top,WIDTH-40,50)];
    self.positionView.titleLab.text = @"职位";
    self.positionView.textField.delegate = self;
    [self.scrollView addSubview:self.positionView];
    //公司行业
    top = top+60;
    self.industryView = [[LLBView alloc] initWithFrame:CGRectMake(20, top, WIDTH-40, 50)];
    _industryView.titleLab.text = @"工司行业";
    [_scrollView addSubview:_industryView];
    //月收入
    top = top+60;
    self.incomeView = [[LTView alloc] initWithFrame:CGRectMake(20, top, WIDTH-40, 50)];
    _incomeView.titleLab.text = @"月收入";
    self.incomeView.textField.delegate = self;
    [_scrollView addSubview:_incomeView];
    //公司地址
    top = top+60;
    self.addressView = [[LLBView alloc] initWithFrame:CGRectMake(20, top, WIDTH-40, 50)];
    _addressView.titleLab.text = @"工作地址";
