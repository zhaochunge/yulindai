...
@interface HouseVC ()<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    [self leftItem];
    _selectPic = 0;
    self.navigationItem.title = @"房产认证";
    ...
    [cerTools title:@"房产认证" font:17 discrib:discribStr withFrame:CGRectMake(20, top, WIDTH-40, height) view:self.scrollView showLine:YES];
