...
@interface CarVC ()<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    [self leftItem];
    _selectPic = 0;
    self.navigationItem.title = @"购车认证";
